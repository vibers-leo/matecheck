...
### 전략 핵심 요약
- **Vision**: 공유 생활의 투명성(미션+가계부) 자동화로 스트레스 없는 일상 실현
- **Beachhead**: 대학가 공동 임차(쉐어하우스) - 월 50-100 Nest
- **North Star**: 월간 활성 Nest당 사용 시간 4시간 (12개월)
- **즉시 과제**: 10개 Nest 베타, NPS 50+, Free→Pro 전환율 20%
